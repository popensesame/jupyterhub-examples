...
import sys
sys.path.insert(1, '/srv/jupyterhub')

from src.handlers.test_page import TestPageHandler
...
#c.JupyterHub.default_url = '/test-page'
...
c.Authenticator.admin_users = set(['hubadmin'])
